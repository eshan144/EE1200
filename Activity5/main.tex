...
\begin{itemize}
	...
	\item Connect the power supply to the op-amp (\(+V_{cc}\) and \(-V_{cc}\)).
\end{itemize}

\item Apply Input Signal:
\begin{itemize}
	\item Connect a function generator to provide a square wave input signal to the circuit.
	\item Set the input signal to \(2 \, \text{V}_{pp}\) amplitude and \(1 \, \text{kHz}\) frequency.
\end{itemize}
...
\section{Observations}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.5\columnwidth]{pics/int_1452.jpeg}
		\caption{Op-Amp Integrator with input 1452 Hz}
	\end{figure}
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.5\columnwidth]{pics/int_1708.jpeg}
		\caption{Op-Amp Integrator with input 1708 Hz}
	\end{figure}
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.5\columnwidth]{pics/int_6049.jpeg}
		\caption{Op-Amp Integrator with input 6049 Hz}
	\end{figure}
